...
```js {2-3,13,18} title="web/src/App.[js/tsx]"
...
```js title="web/src/pages/SignupPage/SignupPage.[js/tsx]"
...
```js {6-8,13} title="web/src/pages/SignupPage/SignupPage.[js/tsx]"
// ...
...
```js {3,6} title="web/src/pages/SignupPage/SignupPage.js"
import { Form, TextField, PasswordField, Submit } from '@redwoodjs/forms'
...
```js {9-17} title="web/src/pages/SignupPage/SignupPage.[js/tsx]"
import { Form, TextField, PasswordField, Submit } from '@redwoodjs/forms'
import { useAuth } from '@redwoodjs/auth'
...
```js {8,11,18,20,28} title="web/src/pages/SignupPage/SignupPage.js"
import { Form, TextField, PasswordField, Submit } from '@redwoodjs/forms'
import { useAuth } from '@redwoodjs/auth'
...
```js {5,18} title="web/src/pages/SignupPage/SignupPage.js"
import { Form, TextField, PasswordField, Submit } from '@redwoodjs/forms'
import { useAuth } from '@redwoodjs/auth'
...
```js title="web/src/pages/SigninPage/SigninPage.[js/tsx]"
import { Form, TextField, PasswordField, Submit } from '@redwoodjs/forms'
...
```js {3,6} title="web/src/pages/SigninPage/SigninPage.js"
import { Form, TextField, PasswordField, Submit } from '@redwoodjs/forms'
import { useAuth } from '@redwoodjs/auth'
...
```js {12-17} title="web/src/pages/SigninPage/SigninPage.js"
import { Form, TextField, PasswordField, Submit } from '@redwoodjs/forms'
import { useAuth } from '@redwoodjs/auth'
...
```js {12-18} title="web/src/pages/SigninPage/SigninPage.js"
import { Form, TextField, PasswordField, Submit } from '@redwoodjs/forms'
import { useAuth } from '@redwoodjs/auth'
...
```js title="web/src/components/SignoutBtn/SignoutBtn.[js/tsx]"
const SignoutBtn = () => {
  const onClick = () => {
    // do sign out here.
  }
...
```js {2,5,8} title="web/src/components/SignoutBtn/SignoutBtn.[js/tsx]"
import { useAuth } from '@redwoodjs/auth'
...
```js {3,9-10} title="web/src/components/SignoutBtn/SignoutBtn.[js/tsx]"
import { useAuth } from '@redwoodjs/auth'
import { navigate, routes } from '@redwoodjs/router'
...
```js title="web/src/components/Navigation/Navigation.js"
...
```javascript {6,9-13} title="web/src/components/Navigation/Navigation.js"
import { Link, routes } from '@redwoodjs/router'
import { useAuth } from '@redwoodjs/auth'
...
```javascript {5,11-18} title="web/src/components/Navigation/Navigation.[js/tsx]"
import { Link, routes } from '@redwoodjs/router'
import { useAuth } from '@redwoodjs/auth'
