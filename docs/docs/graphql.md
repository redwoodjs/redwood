...
Comments in GraphQL schema are enclosed in `"""`.
...
"""Autogenerated input type of InputContact."""
...
Documentation is also generated for thr Redwood Root Schema that defines details about Redwood such as the current user and version information.
```
type Query {
  """
  redwood
...
#### Queries
![graphql-doc-queries](https://user-images.githubusercontent.com/1051633/175786071-b80e9220-c8a9-4a45-94c6-c53faa1c77b1.png)


#### Model Types
![graphql-doc-type](https://user-images.githubusercontent.com/1051633/175786097-0291a7e1-c405-4233-b6d3-e40212633987.png)

#### Input Types
![graphql-doc-mutation-input](https://user-images.githubusercontent.com/1051633/175786119-f569a73f-e6c0-4c91-b4d9-c960c27b0036.png)


### Use in Docusaurus

If your project uses Docusaurus, the generated commented SDL can be used to publish documentation using the [Zhouzi/docusaurus-graphql-plugin](https://github.com/Zhouzi/docusaurus-graphql-plugin).
