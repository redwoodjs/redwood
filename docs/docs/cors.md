...
When will you need to worry about CORS? The short answer is when your web and api sides are deployed to different domains.

For example, if your web side is deployed to `example.com` and your api is deployed to `api.example.com`, you'll need to worry about CORS.
