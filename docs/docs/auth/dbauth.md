...
This configuration allows you to perform a case insensitive check on a username at the point of user creation. You will need to provide the configuration of your choice for both signup and login.
