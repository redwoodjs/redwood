...
| `i18n`             | Set up i18n                                                                                |
| `sentry`           | Setup [Sentry](https://sentry.io/welcome/) error and performance tracking                  |
