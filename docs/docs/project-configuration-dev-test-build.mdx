...
You can customise the types that Redwood generates from your project too! This is documented in a bit more detail [here](typescript/generated-types#customising-codegen-config)
