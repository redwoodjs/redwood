...
While we do runtime checks here to make sure we don't access roles if it doesn't exist, TypeScript in strict mode does not allow it.
...
<details>
<summary>Expand for Example diff</summary>
