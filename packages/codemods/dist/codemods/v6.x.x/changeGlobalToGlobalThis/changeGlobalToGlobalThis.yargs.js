...
const command = exports.command = 'change-global-to-global-this';
const description = exports.description = '(v6.x.x->v6.x.x) Converts world to bazinga';
const handler = () => {
  (0, _tasuku.default)('Change Global To Global This', async ({
    setOutput
  }) => {
    await (0, _runTransform.default)({
      transformPath: _path.default.join(__dirname, 'changeGlobalToGlobalThis.js'),
