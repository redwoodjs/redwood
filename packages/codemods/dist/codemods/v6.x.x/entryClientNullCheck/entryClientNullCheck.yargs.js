...
const command = exports.command = 'entry-client-null-check';
const description = exports.description = '(v6.x.x->v6.x.x) Converts world to bazinga';
const handler = () => {
  (0, _tasuku.default)('Entry Client Null Check', async ({
    setOutput
  }) => {
    await (0, _runTransform.default)({
      transformPath: _path.default.join(__dirname, 'entryClientNullCheck.js'),
      targetPaths: _fastGlob.default.sync('entry.client.{jsx,tsx}', {
