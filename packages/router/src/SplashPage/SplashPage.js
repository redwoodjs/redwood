const SplashPage = ({ isRedwood }) => (
  <>
    ...
    <div className="body">
      <p>
        Thanks for choosing Redwood Router! The first thing you&apos;ll need to
        do is specify a route:
      </p>
      <div className="code">
        <code>
