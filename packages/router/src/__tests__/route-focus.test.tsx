...
// test('getFocus gets a focusable elements and ignores', async () => {
//   const TestRouter = () => (
//     <Router>
//       <Route path="/" page={RouteFocusPage} name="routeFocus" />
//       <Route path="/noRouteFocus" page={NoRouteFocusPage} name="noRouteFocus" />
//       <Route
//         path="/routeFocusNoChild"
//         page={RouteFocusNoChildren}
//         name="routeFocusNoChild"
//       />
//       <Route
//         path="/routeFocusTextNode"
//         page={RouteFocusTextNodePage}
//         name="routeFocusTextNode"
//       />
//       <Route
//         path="/routeFocusNegativeTabIndex"
...
//   // should return null
//   act(() => navigate(routes.noRouteFocus()))
//   await waitFor(() => {
...
//   // should return null
//   act(() => navigate(routes.routeFocusNoChild()))
//   await waitFor(() => {
//     screen.getByText(/Route Focus No Child Page/i)
//     const routeFocus = getFocus()
//     expect(routeFocus).toBeNull()
//   })

//   // should return null
//   act(() => navigate(routes.routeFocusTextNode()))
//   await waitFor(() => {
...
//   // should return null
//   act(() => navigate(routes.routeFocusNegativeTabIndex()))
//   await waitFor(() => {
