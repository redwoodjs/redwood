...
export const notes = [
  ...
  '',
  'Do not make your `UserCredential` model available via GraphQL! This',
  'means do not create an SDL or scaffold for it. This data should remain',
  'private to the api-side only.',
  '',
  'If you end up re(generating) an SDL file for `User`, it will include the',
  '`credentials` relationship. You will need to manually remove this line`',
  'since there is no `UserCredential` type defined for GraphQL (because you',
  "didn't generate any SDL for it, right??).",
  '',
