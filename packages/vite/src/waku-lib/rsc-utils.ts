...
export const codeToInject = `
    ...
    globalThis.__webpack_chunk_load__ = (id) => import(id).then((m) => globalThis.__rw_module_cache__.set(id, m));
    globalThis.__webpack_require__ = (id) => globalThis.__rw_module_cache__.get(id);\n  `
