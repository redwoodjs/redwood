...
4. then applies code mods from the [Redwood tutorial](/docs/tutorial/forward/) to add functionality and styling
...
We use Cypress to test the steps in the [tutorial](/docs/tutorial/forward/). You can run this end-to-end (e2e) test locally by running the following in your local copy of the Redwood Framework:
